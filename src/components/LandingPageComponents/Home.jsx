            ...
            <div className="flex flex-col justify-center items-start lg:mr-60 max-w-sm lg:max-w-lg mt-10 sm:mt-0 relative">
              ...
              <animated.div style={animateAfterStyles}>
                <Link
                  ...
                  smooth
                  duration={800}
                  className="group flex items-center text-base xl:text-xl border border-ice bg-black text-ice w-fit my-6 md:px-6 sm:py-3 py-2 px-4 rounded-md hover:bg-ice hover:text-charcoal duration-500 cursor-pointer relative"
                >
                  Projects
